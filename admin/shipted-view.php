...
<?php
if(isset($_GET["shipt_view"]) && $_GET["shipt_view"] != NULL){
  $shipt_id = $_GET["shipt_view"];
?>
        <div class="grid_10">
                  ...
                  <style media="screen">
                   ...
                   <div class="divOne">
                     <table class="tblOne">
                       ...
                       $shiptObj->shipt_id($shipt_id);
                       foreach ($shiptObj->shiptviewlist() as $value) {
                   ...
                   <div class="divtwo">
                      ...
                      <div class="subDivTwo">
                          <table class="tblThree">
                            ...
                            <?php } ?>
                            <?php
                            foreach ($shiptObj->brandAndCat() as $value) {
                            ?>
                            <tr>
                              <td>Brand</td>
                              <td>:</td>
